namespace SignalTracker.Helper
{
    ...
    public static class Constant
    {
        ...
        public static readonly string[] TempFiles = new string[] { "", "Session_Template.zip","Template_NetworkLog.csv","Site_Prediction_Data.csv","python-runtime-v1-win-x64.zip" };
